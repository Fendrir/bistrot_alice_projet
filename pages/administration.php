...
if(!isset($_SESSION['nick']) || $_SESSION['nick'] !== 'Franck') {
    ...
    function banEvent($server = 'localhost', $user = 'root', $pwd = 'admin', $db = 'bistrot')
    {
        ...
        while ($row = $result->fetch_assoc()) {
            ?>
<!--            <div id="buttonEventDiv" class="hidden">-->
...
<!--            </div>-->
    ...
    function video($server = 'localhost', $user = 'root', $pwd = 'admin', $db = 'bistrot'){
        ...
        while($row = $result->fetch_assoc()){
            ?>
            <div id="buttonVideoDiv" class="col-md-4 border btn btn-warning">
            <h4>Vidéo</h4>
    ...
    function multi($globalDivTitle = 'buttonPlat', $title = 'pla_title', $img = 'pla_img', $table = 'plat', $oid = 'pla_oid',
        ...
        while ($row = $result->fetch_assoc()) {
            ?>
            <div id="<?= $globalDivTitle; ?>Div" class="col-md-4 border btn btn-warning">
                <h4><?= $titleDiv . ' ' . $i; ?></h4>
...
<!--                <li><button id="buttonEvent" class="btn btn-success">Evènements</button></li>-->
<!--                <li><button id="buttonVideo" class="btn btn-success">Vidéo</button></li>-->
<!--                <li><button id="buttonCarte" class="btn btn-success">Cartes</button></li>-->
<!--                <li><button id="buttonPlat" class="btn btn-success">Plats</button></li>-->
<!--            </ul>-->
<!--        </div>-->
<!--        <div class="row">-->
