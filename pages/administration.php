        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <div class="col-md-6 btn btn-warning">
                <form class="mt-3 btn btn-info" method="post" action="?p=uploadevent" enctype="multipart/form-data">
                    ...
                    <input class="input-group mt-3 text-center" type="text" name="titre" id="titre" placeholder="Nom de l'évènement"><br>
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <div class="col-md-4 border btn btn-warning">
                ...
                <form class="mt-3  " method="post" action="<?= $uploadURL . '&id=' . $i; ?>"
                    ...
                    <input class="form-group mt-3 text-center" type="text" name="titre" id="titre" placeholder="<?= $titleInput; ?>"><br>
